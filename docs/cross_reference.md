...
| SocketContext.tsx           | Establishes WebSocket connection to the backend Socket.IO server                  | Socket.IO Server               |
| ThemeContext.tsx            | Manages UI theme state (light/dark)                                              | N/A                           |
---